...
class LLBrowserActionSheet: UIView, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        if section == 1 {
            ...
            view.backgroundColor = UIColor.init(red: 184.0/255.0, green: 184.0/255.0, blue: 184.0/255.0, alpha: 1.0)
            return view
        }
        return nil
    }
